...
public class LoanFormActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private TextView paid_dateTv;
    private TextView total_amountTV;
    private LinearLayout addlenderLAy;
    private LinearLayout loanForm;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout payForm = findViewById(R.id.pay_form);
        spinner = findViewById(R.id.spinner);
        dateTv = findViewById(R.id.dateTV);
        paid_dateTv = findViewById(R.id.paid_dateTV);
        TextView paidtotal_amountTV = findViewById(R.id.paidtotal_amountTV);
        TextView paidlender_nameET = findViewById(R.id.paidlender_nameET);
...
//                                System.out.println("======== lender id 2 ====== " + );
        ...
        add_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cdate.length() == 0) {
                    ...
                    //name
                    addTransection(lender_id, amount, rate, month, total_amt, cdate, trans_type, "");
        ...
        pay_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (date.length() == 0) {
                    ...
                    //lendername
                    addTransection(lender_id, "", "", "", "", date, trans_type, paid_amount);
    ...
    private void addTransection(String lender_id, String loan_amount, String rate,
        ...
        params.put("lender_name", lender_id);
